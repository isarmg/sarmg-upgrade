...
Foundation 的 `sarmg-contracts`、`sarmg-schema-identity` 均以 `=0.6.0` 和不可变 Git rev
`1e889d08fa69fcf2b5fffe45e8cc42b68218f4f1` 提供 driver-independent 当前线类型和 schema 算法；本仓库
