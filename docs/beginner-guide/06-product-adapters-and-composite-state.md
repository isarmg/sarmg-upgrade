...
本工具依赖 Foundation `sarmg-contracts =0.6.0` 与 `sarmg-schema-identity =0.6.0`，两者 Git rev 都是
`1e889d08fa69fcf2b5fffe45e8cc42b68218f4f1`。这说明共享当前线类型和算法来自 Foundation；不表示 Foundation
