...
共享 `sarmg-contracts =0.6.0` 和 `sarmg-schema-identity =0.6.0` 同样只描述当前协议；两者只从不可变
Git rev `1e889d08fa69fcf2b5fffe45e8cc42b68218f4f1` 取得。精确依赖的意义是让各项目对当前 manifest、metadata
